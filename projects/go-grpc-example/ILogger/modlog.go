...
func (p *Provider) GetLogger(module string) Logger {
...
func LoggerProviderFunc() LoggerProvider {
	return &Provider{}
}
...
func InitLogger(l LoggerProvider) {
...
func getLoggerOpts(module string, level Level) *loggerOpts {
	rwmutex.RLock()
	defer rwmutex.RUnlock()
	return &loggerOpts{
...
func (l *Log) Fatal(args ...interface{}) {
	opts := getLoggerOpts(l.module, CRITICAL)
	if l.loadCustomLogger() {
		l.customLogger.Fatal(args...)
		return
	}
	l.log(opts, CRITICAL, args...)
...
func (l *Log) Fatalf(format string, args ...interface{}) {
	...
	l.logf(opts, CRITICAL, format, args...)
...
func (l *Log) Debug(args ...interface{}) {
	opts := getLoggerOpts(l.module, DEBUG)
...
func (l *Log) Debugln(args ...interface{}) {
	...
	l.logln(opts, DEBUG, args...)
}

// Info calls go log.Output.
// Arguments are handled in the manner of fmt.Print.
func (l *Log) Info(args ...interface{}) {
	opts := getLoggerOpts(l.module, INFO)
	if !opts.levelEnabled {
		return
	}
	if l.loadCustomLogger() {
...
func (l *Log) Infoln(args ...interface{}) {
	...
	l.logln(opts, INFO, args...)
}

// Warn calls go log.Output.
// Arguments are handled in the manner of fmt.Print.
func (l *Log) Warn(args ...interface{}) {
	opts := getLoggerOpts(l.module, WARNING)
	if !opts.levelEnabled {
		return
	}
	if l.loadCustomLogger() {
...
func (l *Log) Warnf(format string, args ...interface{}) {
	...
	l.logf(opts, WARNING, format, args...)
}
...
func (l *Log) Warnln(args ...interface{}) {
	...
	l.logln(opts, WARNING, args...)
}

// Error calls go log.Output.
// Arguments are handled in the manner of fmt.Print.
func (l *Log) Error(args ...interface{}) {
	opts := getLoggerOpts(l.module, ERROR)
	if !opts.levelEnabled {
		return
	}
	if l.loadCustomLogger() {
...
func (l *Log) logf(opts *loggerOpts, level Level, format string, args ...interface{}) {
	//Format prefix to show function name and log level and to indicate that timezone used is UTC
	customPrefix := fmt.Sprintf(logLevelFormatter, l.getCallerInfo(opts), ParseString(level))
...
func (l *Log) log(opts *loggerOpts, level Level, args ...interface{}) {
	//Format prefix to show function name and log level and to indicate that timezone used is UTC
	customPrefix := fmt.Sprintf(logLevelFormatter, l.getCallerInfo(opts), ParseString(level))
...
func (l *Log) logln(opts *loggerOpts, level Level, args ...interface{}) {
	//Format prefix to show function name and log level and to indicate that timezone used is UTC
	customPrefix := fmt.Sprintf(logLevelFormatter, l.getCallerInfo(opts), ParseString(level))
