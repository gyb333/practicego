...
var file_stream_proto_rawDesc = []byte{
	...
	0x50, 0x6f, 0x69, 0x6e, 0x74, 0x52, 0x02, 0x70, 0x74, 0x32, 0xb8, 0x01, 0x0a, 0x06, 0x53, 0x74,
	0x72, 0x65, 0x61, 0x6d, 0x12, 0x37, 0x0a, 0x04, 0x4c, 0x69, 0x73, 0x74, 0x12, 0x14, 0x2e, 0x70,
...
var file_stream_proto_depIdxs = []int32{
	...
	1, // 2: proto.Stream.List:input_type -> proto.StreamRequest
	1, // 3: proto.Stream.Record:input_type -> proto.StreamRequest
	1, // 4: proto.Stream.Route:input_type -> proto.StreamRequest
	2, // 5: proto.Stream.List:output_type -> proto.StreamResponse
	2, // 6: proto.Stream.Record:output_type -> proto.StreamResponse
	2, // 7: proto.Stream.Route:output_type -> proto.StreamResponse
...
func (c *streamClient) List(ctx context.Context, in *StreamRequest, opts ...grpc.CallOption) (Stream_ListClient, error) {
	stream, err := c.cc.NewStream(ctx, &_Stream_serviceDesc.Streams[0], "/proto.Stream/List", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *streamClient) Record(ctx context.Context, opts ...grpc.CallOption) (Stream_RecordClient, error) {
	stream, err := c.cc.NewStream(ctx, &_Stream_serviceDesc.Streams[1], "/proto.Stream/Record", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *streamClient) Route(ctx context.Context, opts ...grpc.CallOption) (Stream_RouteClient, error) {
	stream, err := c.cc.NewStream(ctx, &_Stream_serviceDesc.Streams[2], "/proto.Stream/Route", opts...)
	if err != nil {
		return nil, err
	}
