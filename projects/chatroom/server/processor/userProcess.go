...
func (this *UserProcess) NotifyMeOnline(userId int) {
	...
	if err != nil {
		log.Println("NotifyMeOnline err=", err)
		return
	}
}
...
func (this *UserProcess) ServerProcessRegister(mes *message.Message) (err error) {
	...
	resMes.Type = message.RegisterRstMsgType
...
func (this *UserProcess) ServerProcessLogin(mes *message.Message) (err error) {
	...
	//1先声明一个 resMes
	var resMes message.Message
	resMes.Type = message.LoginRstMsgType
...
func (this *UserProcess) ServerLoginExist(mes *message.Message)(err error){
	//1先声明一个 resMes
	var resMes message.Message
	resMes.Type = message.LoginExistRstMsgType
	//2在声明一个 LoginResMes，并完成赋值
